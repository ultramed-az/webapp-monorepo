...
export default function AdminPrivacyPolicyPage() {
    return (
        <div className="space-y-6">
            <div>
                <h2 className="text-2xl font-bold tracking-tight text-slate-900">Mexfilik Siyaseti (Admin)</h2>
                <p className="text-slate-500">Saytda gosterilen mexfilik metnini buradan idare edin.</p>
            </div>
