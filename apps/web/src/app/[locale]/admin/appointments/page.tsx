                            ...
                            <TableBody>
                                {initialAppointments.map((appointment) => (
                                    <TableRow key={appointment.id}>
                                        ...
                                        <TableCell>
                                            <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium border ${appointment.status === 'confirmed' ? 'bg-brand-blue-soft text-brand-blue border-brand-blue/20' :
                                                    appointment.status === 'completed' ? 'bg-brand-blue-soft text-brand-blue border-brand-blue/20' :
                                        ...
                                        <TableCell className="text-right">
                                            <DropdownMenu>
                                                ...
                                                <DropdownMenuContent align="end">
                                                    <DropdownMenuItem className="cursor-pointer text-brand-blue focus:text-brand-blue focus:bg-brand-blue-soft">
