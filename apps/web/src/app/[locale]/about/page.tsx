    ...
    const coreValues = [
        {
            ...
            desc: t('coreValues.items.0.description'),
        ...
        },
        {
            ...
            desc: t('coreValues.items.1.description'),
        ...
        },
        {
            ...
            desc: t('coreValues.items.2.description'),
            color: 'bg-brand-orange/10 border-brand-orange/20'
        }
    ];
    ...
    const timeline = [
        {
            ...
            desc: t('timeline.items.0.description'),
        },
        {
            year: t('timeline.items.1.year'),
            title: t('timeline.items.1.title'),
            desc: t('timeline.items.1.description'),
        },
        {
    ...
    return (
        <div className="flex flex-col min-h-screen">
            ...
            <section className="py-20 bg-slate-50 border-y border-slate-100">
                <div className="container mx-auto px-6">
                    <div className="text-center max-w-3xl mx-auto mb-16">
                        <h2 className="text-3xl font-bold text-slate-900 mb-4">{t('coreValues.title')}</h2>
            ...
            <section className="py-20 bg-white">
                <div className="container mx-auto px-6">
                    <div className="text-center max-w-3xl mx-auto mb-16">
                        <h2 className="text-3xl font-bold text-slate-900 mb-4">{t('timeline.title')}</h2>
                        <p className="text-slate-600 text-lg">
                ...
                <div className="container mx-auto px-6">
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 text-center divide-x divide-white/20">
                        <div className="px-4">
                            ...
                            <div className="text-white/85 font-medium">{t('stats.experience')}</div>
                        </div>
                        <div className="px-4">
                            <div className="text-4xl md:text-5xl font-extrabold mb-2 text-brand-orange">15K+</div>
                            <div className="text-white/85 font-medium">{t('stats.patients')}</div>
                        </div>
                        <div className="px-4">
                            <div className="text-4xl md:text-5xl font-extrabold mb-2 text-brand-orange">50+</div>
                            <div className="text-white/85 font-medium">{t('stats.doctors')}</div>
                        </div>
                        <div className="px-4">
                            <div className="text-4xl md:text-5xl font-extrabold mb-2 text-brand-orange">20+</div>
                            <div className="text-white/85 font-medium">{t('stats.departments')}</div>
                        </div>
                    </div>
                </div>
            </section>
