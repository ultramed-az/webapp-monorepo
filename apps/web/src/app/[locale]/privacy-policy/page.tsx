...
import { getPrivacyPolicyPage, isBackendUnavailableError, type ContentPageResponse } from '@/lib/api';
        ...
        async function loadContent() {
            ...
            try {
                ...
                if (!isCancelled) {
                    ...
                    const message =
                        fetchError instanceof Error ? fetchError.message : 'Failed to load privacy policy';
                    setError(message);
                }
            } finally {
                if (!isCancelled) {
