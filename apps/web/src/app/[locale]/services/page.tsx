...
export default function ServicesPage() {
    ...
    const services = [
        ...
        {
            id: 'pediatriya',
            icon: <Baby className="h-10 w-10 text-sky-500" />,
            title: 'Pediatriya',
        ...
        {
            id: 'cərrahiyyə',
            icon: <Syringe className="h-10 w-10 text-orange-500" />,
        ...
        {
            id: 'travmatologiya',
            icon: <Bone className="h-10 w-10 text-slate-500" />,
    ...
    return (
        <div className="flex flex-col min-h-screen">
            {/* Page Header */}
            <section className="bg-blue-900 text-white py-16 md:py-20 lg:py-24 relative overflow-hidden">
                <div className="absolute inset-0 z-0 opacity-20 bg-[radial-gradient(circle_at_bottom_right,_var(--tw-gradient-stops))] from-blue-300 via-transparent to-transparent"></div>
                        ...
                        {services.map((service, idx) => (
                            <Card key={idx} className="border-slate-200 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col h-full bg-white group">
                                ...
                                <CardFooter className="pt-4 border-t border-slate-50 mt-auto">
                                    <Link href={`/services/${service.id}`} className="inline-flex items-center text-sm font-semibold text-blue-600 hover:text-blue-800 transition-colors">
            ...
            <section className="py-20 bg-white border-t border-slate-100">
                <div className="container mx-auto px-6 text-center max-w-4xl">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-4">
                        <Button size="lg" className="bg-blue-600 hover:bg-blue-700 text-white rounded-full h-14 px-8 text-base">
                            Terapevt Qəbulu Üçün Yazılın
                        </Button>
                        <Button size="lg" variant="outline" className="border-slate-300 text-slate-700 hover:bg-slate-50 rounded-full h-14 px-8 text-base">
                            Sual Verin
                        </Button>
                    </div>
                </div>
